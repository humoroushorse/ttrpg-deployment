...
Common labels
*/}}
{{- define "go-sprint.labels" -}}
helm.sh/chart: {{ include "go-sprint.chart" . }}
{{ include "go-sprint.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "go-sprint.selectorLabels" -}}
app.kubernetes.io/name: {{ include "go-sprint.name" . }}
...
*/}}
{{- define "go-sprint.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "go-sprint.fullname" .) .Values.serviceAccount.name }}
{{- else }}
